...
function pageMax(infoMode){//文本最后记得加一个空格
	switch(infoMode){
		...
		case 'words_random':return 3;
		case 'keywords_C++':return 2; 
		case 'keywords_C':return 1; 
		case 'keywords_JAVA':return 1; 
		case 'keywords_python':return 0; 
		case 'keywords_php':return 1; 
		case 'keywords_mixed':return 4; 
